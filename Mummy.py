...
check_internet() {
    ...
    if [ "$?" != '0' ]; then
        printf "${RED}${BOLD}Internet kon On Karai ga?? ${RESET}\n"
        exit 1
    fi
}
...
main() {
    ...
    echo -e "${RED}
 '      --[[
  ____________________ __________.__    .__       .__                  
 /   _____/\_   _____/ \______   \  |__ |__| _____|  |__   ___________ 
 \_____  \  |    __)    |     ___/  |  \|  |/  ___/  |  \_/ __ \_  __ \
 /        \ |     \     |    |   |   Y  \  |\___ \|   Y  \  ___/|  | \/
/_______  / \___  /     |____|   |___|  /__/____  >___|  /\___  >__|   
...
[2] VK poll
${RESET}"
    read -p $'\e[31;4m\e[0m set(\e[33mVK/Vector\e[0m) > ' vk_option
